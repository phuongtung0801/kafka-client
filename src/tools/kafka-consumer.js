            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, producer.send({
                            topic: topic,
                            messages: messages.map(function (message) { return ({ value: message }); }),
                        })];
                case 2:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, consumer.subscribe({ topic: 'my-topic', fromBeginning: true })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, consumer.run({
                            eachMessage: function (_a) {
                                var topic = _a.topic, partition = _a.partition, msg = _a.message;
                                return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_b) {
                                        console.log("Received message: ".concat(msg.value, " at partition ").concat(partition, " of topic ").concat(topic));
                                        return [2 /*return*/];
                                    });
                                });
                            },
